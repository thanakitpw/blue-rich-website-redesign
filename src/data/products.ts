...
export const products: Product[] = [
  {
    ...
    downloads: [
      { label: "Technical Data Sheet", href: "/docs/neocoat-s-tds-bluerich.pdf" },
    ],
...

  {
    ...
    name: "ทินเนอร์ล้าง AAA ชนิดแกลลอน",
    category: "thinner-turpentine",
    tagline:
      "ทินเนอร์ AAA ชนิดแกลลอน ปริมาณ 1.9 กิโลกรัม ใช้เป็นตัวทำละลายผสมสีสูตรน้ำมัน และใช้ล้างแปรง กาพ่นสี และภาชนะใส่สีหลังใช้งาน",
    cardSummary: "1.9 / 9 / 15 / 150 กก. · ผสมสีและล้างอุปกรณ์",
    badges: ["พร้อมส่ง", "ใช้ล้างอุปกรณ์ได้"],
    quickSpecs: [
      { label: "ขนาดบรรจุ", value: "1.9 กก. · 9 / 15 / 150 กก." },
    ...
    description: [
      "ทินเนอร์ AAA ชนิดแกลลอน ปริมาณ 1.9 กิโลกรัม ใช้เป็นตัวทำละลายสำหรับผสมสีสูตรน้ำมัน และใช้ล้างทำความสะอาดแปรงทา กาพ่นสี และภาชนะที่ใส่สีหลังจบงาน",
    ...
    specs: [
      { label: "ประเภท", value: "ทินเนอร์ AAA" },
      { label: "ขนาดบรรจุ", value: "แกลลอน 1.9 กก. · 9 / 15 / 150 กก." },
    ...
    faq: [
      {
        ...
        a: "เป็นทินเนอร์ AAA เหมือนกัน ต่างที่ยี่ห้อและขนาดบรรจุ — ตัวนี้เป็นแกลลอน 1.9 กก. เหมาะกับงานขนาดเล็กถึงกลาง ส่วนอินทนิลมีขนาด 9 / 15 / 150 กก. สำหรับงานปริมาณมาก",
      },
      {
        q: "ใช้ผสมสีกันไฟ Neocoat ได้ไหม?",
