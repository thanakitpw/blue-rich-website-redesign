...
export const products: Product[] = [
...

  {
    ...
    cardSummary: "แกลลอน 1.9 กก. · ผสมสีและล้างอุปกรณ์",
    badges: ["พร้อมส่ง", "ใช้ล้างอุปกรณ์ได้"],
    quickSpecs: [
      { label: "ขนาดบรรจุ", value: "แกลลอน 1.9 กก." },
    ...
    lists: [
      {
        title: "ขั้นตอนการทำละลายสีด้วยทินเนอร์",
        items: [
          "ทำความสะอาดพื้นผิวชิ้นงานให้สะอาด — งานเหล็กควรขัดด้วยกระดาษทรายเบอร์ 80, 120, 150 แล้วไล่ไปถึงเบอร์ 320 ขึ้นกับความละเอียดที่ต้องการ จากนั้นเช็ดฝุ่นออกให้หมด",
          "เลือกภาชนะที่ทนการกัดกร่อนของทินเนอร์ เช่น แก้ว ถังพลาสติก หรือถังสี",
          "ใส่เนื้อสีลงภาชนะ 3 ต่อ 4 ส่วน ถ้าเนื้อสีเข้มข้นมากใช้ 2.5 ต่อ 4 ส่วน",
          "เติมทินเนอร์ 1 ต่อ 4 ส่วน ถ้าเนื้อสีเข้มข้นมากใช้ 1.5 ต่อ 4 ส่วน",
          "คนด้วยไม้หรือตะเกียบให้ทินเนอร์กับสีเข้าเป็นเนื้อเดียวกันก่อนนำไปใช้",
          "นำไปใส่กาพ่นสี หรือใช้แปรงทา",
        ],
      },
      {
