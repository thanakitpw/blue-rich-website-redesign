...
export const standards: Standard[] = [
  {
    ...
    body: [
      ...
      "ระบบสีกันไฟ Neocoat ผ่านการทดสอบวัสดุป้องกันไฟ จากศูนย์วิจัยเพื่อความปลอดภัยจากอัคคีภัย ภาควิชาวิศวกรรมโยธา จุฬาลงกรณ์มหาวิทยาลัย และมีรายงานผลทดสอบฉบับล่าสุดจาก TÜV SÜD ประกอบอีกฉบับ",
    ],
    points: [
  ...
  {
    slug: "nor-4-5-4-9",
    label: "แบบ กสอ. น.4-5 / น.4-9",
    note: "รับรองโดยวุฒิวิศวกรโยธา",
    image: "/assets/fireproofing-certification.jpg",
    eyebrow: "Engineer Certified",
    title: "แบบ กสอ. น.4-5 / น.4-9 — เอกสารรับรองรายโครงการ",
    body: [
      ...
      "เอกสารชุดนี้ต่างจากผลทดสอบผลิตภัณฑ์ — ผลทดสอบเป็นของตัวสี ส่วน น.4-5 / น.4-9 ออกให้เฉพาะโครงการของคุณ หลังคำนวณความหนาฟิล์มตามหน้าตัดจริงและตรวจวัดหน้างานแล้ว ทางบริษัทฯ ให้บริการจัดทำเอกสารชุดนี้ให้ทุกโครงการที่ใช้ผลิตภัณฑ์ของเรา",
    ],
    points: [
      "คำนวณความหนาฟิล์มตามค่า Hp/A ของหน้าตัดจริงรายชิ้น",
      "ตรวจวัดความหนาฟิล์มหน้างานทั้งขณะเปียกและเมื่อแห้ง",
      "ลงนามโดยวุฒิวิศวกรโยธา ใช้ยื่นขออนุญาตและตรวจรับงานได้",
    ],
  },
];
