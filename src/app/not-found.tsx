...
/**
 * Unmatched URLs render against the root layout, which carries no chrome — the
 * header and footer are pulled in here so a 404 still looks like the site.
 */
export default function NotFound() {
  return (
    <>
      <Header />
      <main className="relative overflow-hidden bg-brand-950 py-40">
        <div
          aria-hidden
